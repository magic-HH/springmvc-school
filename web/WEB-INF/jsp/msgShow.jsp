...
<div class="content-wrapper">
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" style="color: #c12e2a">未处理消息</li>
            <li class="breadcrumb-item">
                <a href="msgShowDone">已处理消息</a>
            </li>
        </ol>
    </div>
            ...
            <table class="table table-bordered col-8">
                ...
                <tr>
                    <form action="changePresonMsg">
                        ...
                        <td><%
                            if (!i.getMsgtype().equals("1")) {
                                out.print("&nbsp暂时无可选项&nbsp");
                                out.print("<input type=\"hidden\" name=\"getjob\" value=\"-1\">");
                            } else {
                                out.print("<select class=\"form-control\" name=\"getjob\"> \n" +
                                        "<option value=\"1\">确认接单</option> \n" +
                        ...
                        <td><%
                            if (!i.getMsgtype().equals("1")) {
                                out.print("<button class=\"btn btn-success\" type=\"submit\">确认已读</button>");
                            } else {
                                out.print("<button class=\"btn btn-primary\" type=\"submit\">确定提交</button>");
                            }
                        %></td>
                ...
                <tr>
                    <td colspan="2"></td>
                    <td colspan="3">
                        <a href="msgShow?page=0"><button class="btn btn-primary">1</button>&nbsp;&nbsp;</a>
                        <%
                            if(maxpage<=1){
                            ...
                            if(pagenow==0){
                                ...
                                out.print("<a href=\"msgShow?page="+(pagenow-1)+"\"><button class=\"btn btn-success\"><</button></a>");
                            }%>
                        ...
                        %>
                        <a href="msgShow?page=<%=maxpage%>">&nbsp;&nbsp;<button class="btn btn-primary"><%=maxpage+1%></button></a>
