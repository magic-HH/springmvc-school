...
//ResultSet data_1 = (ResultSet)request.getAttribute("data_1");
    ArrayList<foods> temp_fs =(ArrayList<foods>)request.getAttribute("dataset");
...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="top">
                    <div class="imgWrap"><img src="<%=i.getImg()%>" alt=""></div>
                    <div class="Detil">
                        <div class="til">评价: <%=i.getName()%></div>
                        <div class="stars">
                            <ul>
                                <li class="fa fa-star" num="0"></li>
                                <li class="fa fa-star" num="1"></li>
                                <li class="fa fa-star" num="2"></li>
                                <li class="fa fa-star" num="3"></li>
                                <li class="fa fa-star" num="4"></li>
                            </ul>
                        </div>
                    </div>

                </div>
                <form action="comment_do">
                <div class="body">
                    <input type="hidden" name="foodsid" value="<%=i.getFoodsid()%>">
                    <textarea name ="comment"  fid rows="4"><%=i.getComment()%></textarea>
                </div>
                <div class="foot"><input type="submit" value="评价" class="btn btn-primary float-right"></div>
                </form>
        </div>
